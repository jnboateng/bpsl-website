                    ...
                    <div className="space-y-6">
                            ...
                            {expandedQuestions.q1 && (
                                <div className="p-4 pt-0 border-t border-gray-200">
                                    <p className="text-gray-700">
                                        ...
                                        personal and business loans, fixed deposit products, SUSU savings, 
                        ...
                        <div className="border border-gray-200 rounded-lg">
                            ...
                            {expandedQuestions.q2 && (
                                <div className="p-4 pt-0 border-t border-gray-200">
                                    <p className="text-gray-700">
                                        Any Ghanaian resident aged 18 and above with a valid national ID 
                                        (e.g., Ghana Card, Passport, or Driver's License) can open an account. 
                                        Minors can also open accounts with a guardian's consent.
                                    </p>
                                </div>
                            )}
                        </div>
                            ...
                            {expandedQuestions.q4 && (
                                <div className="p-4 pt-0 border-t border-gray-200">
                                    <p className="text-gray-700">
                                        ...
                                        transfer funds, buy airtime, and more.
                                    </p>
                                </div>
                            )}
                        </div>
                            ...
                            {expandedQuestions.q8 && (
                                <div className="p-4 pt-0 border-t border-gray-200">
                                    <p className="text-gray-700">
                                        ...
                                        access our services through our mobile platforms.
                                    </p>
                                </div>
                            )}
                        </div>
                        ...
                        <div className="border border-gray-200 rounded-lg">
                            ...
                            {expandedQuestions.q9 && (
                                <div className="p-4 pt-0 border-t border-gray-200">
                                    <p className="text-gray-700">
                                        Yes, some account types can be initiated online, but a visit to your 
                                        nearest branch may be required to complete KYC (Know Your Customer) 
                                        verification.
                                    </p>
                                </div>
                            )}
                        ...
                        <div className="border border-gray-200 rounded-lg">
                            ...
                            {expandedQuestions.q10 && (
                                <div className="p-4 pt-0 border-t border-gray-200">
                                    <p className="text-gray-700">
                                        You can reach us via our toll-free number 0800 505050, WhatsApp, email, 
                                        or by visiting any of our branches. We are committed to resolving 
