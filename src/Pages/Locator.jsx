...
function Locator() {
  return (
    <div>
      ...
      {/* Map Section - Full height on mobile, adjusted on larger screens */}
      <div className="relative z-0 h-[60vh] md:h-screen mt-12">
        {/* Background */}
        <div
      ...
      {/* Get in Touch Section - Now appears below on mobile */}
      <div className="bg-gradient-to-r from-purple-200 to-purple-300 h-auto md:h-48 w-full md:w-2/3 mx-auto mt-8 md:mt-24 rounded-3xl relative p-6">
        <div
          className="absolute top-0 right-2 w-full md:w-1/3 h-full object-cover md:bg-contain opacity-60 bg-no-repeat"
        ...
        <div className="z-10 text-white">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 px-4 md:px-16 mt-8 md:mt-12 gap-6">
            {/* Phone */}
