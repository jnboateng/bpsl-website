...
function Describe() {
  return (
    <div>
      <div className="relative mt-12 min-h-[60vh] flex flex-col items-center px-4 sm:px-8">
        <div className="absolute top-8 flex flex-col sm:flex-row gap-6 sm:gap-x-16 justify-start w-full items-center sm:items-start">
          ...
          <div className="w-full text-center lg:text-left lg:w-[80vw] ">
            <h2 className="text-3xl sm:text-5xl font-semibold text-purple-200">
              Discover <span className="text-purple">Exciting </span>
              Career
            </h2>
            <h2 className="text-4xl sm:text-6xl font-bold text-purple-200 mb-4">
